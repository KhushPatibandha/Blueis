...
func HandleHget(connection net.Conn, parts []string, hashMap map[string]map[string]string, setMap map[string]map[string]string, listMap map[string][]string, connAndCommands map[net.Conn][]string, dataStr string, flag bool) string {
	if flag {
